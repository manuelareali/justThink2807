...
<body>
	...
	<form action="mappa.jsp" name="reg" method="POST">
		...
		<div class="cordinate" >	
			<label id = "Indicatore" for="latitude">Latitude:</label> <input id = "Indicatore"  id="latitude"
				type="text" /> <label id = "Indicatore"  for="longitude">Longitude:</label> <input id = "Indicatore"
				 id="longitude" type="text" />
		</div>
